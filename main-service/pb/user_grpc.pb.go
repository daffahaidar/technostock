...
func (c *userServiceClient) UpdateLastRead(ctx context.Context, in *UpdateLastReadRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, UserService_UpdateLastRead_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) UpdateLastRead(context.Context, *UpdateLastReadRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateLastRead not implemented")
}
